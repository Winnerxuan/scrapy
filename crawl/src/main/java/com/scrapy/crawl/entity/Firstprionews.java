...
public class Firstprionews implements Serializable {
    private String newstitle;

    private String newstiems;
    ...
    public String getNewstiems() {
        return newstiems;
    }

    public void setNewstiems(String newstiems) {
        this.newstiems = newstiems == null ? null : newstiems.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        Firstprionews other = (Firstprionews) that;
        return (this.getNewstitle() == null ? other.getNewstitle() == null : this.getNewstitle().equals(other.getNewstitle()))
            && (this.getNewstiems() == null ? other.getNewstiems() == null : this.getNewstiems().equals(other.getNewstiems()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getNewstiems() == null) ? 0 : getNewstiems().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", newstiems=").append(newstiems);
